...
function Form(options) {
  ...
  self.oname = options.oname || false;
...
function handleFile(self, fileStream) {
  ...
  var publicFile = {
    ...
    path: uploadPath(self.uploadDir, fileStream.filename,self.oname),
...
function uploadPath(baseDir, filename,oname) {
  var ext = path.extname(filename).replace(FILE_EXT_RE, '$1');
  if(!oname){
    filename = randoString(18) + ext;
  }
